#' Generate a symmetric affinity matrix based on distance matrix using 'local' Gaussian kernel
#'
...
spectral_clustering <- function(A, k, type=2, verbose=F)
{
  n = nrow(A)
  d = rowSums(A)
